      ...
      planes.forEach((plane) => {
        clonedScene.traverse((child) => {
          if ((child as THREE.Mesh).isMesh) {
            ...
            // Disable shadow casting for all meshes except the visible frame parts
            // You'll need to inspect your model to identify the correct mesh names
            ...
            if (mesh.name.includes('frame_visible') || mesh.name.includes('front_panel')) {
              ...
              mesh.castShadow = false; // Disable shadow casting for other parts
            }
